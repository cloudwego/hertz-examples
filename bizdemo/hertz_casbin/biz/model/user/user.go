...
var FindUserResponse_Baseresp_DEFAULT *BaseResp

func (p *FindUserResponse) GetBaseresp() (v *BaseResp) {
	if !p.IsSetBaseresp() {
		return FindUserResponse_Baseresp_DEFAULT
	}
	return p.Baseresp
}
...
func (p *FindUserResponse) IsSetBaseresp() bool {
	return p.Baseresp != nil
}
...
func NewMemberListResponse() *MemberListResponse {
	return &MemberListResponse{}
}

var MemberListResponse_Baseresp_DEFAULT *BaseResp

func (p *MemberListResponse) GetBaseresp() (v *BaseResp) {
	if !p.IsSetBaseresp() {
		return MemberListResponse_Baseresp_DEFAULT
	}
	return p.Baseresp
}

var fieldIDToName_MemberListResponse = map[int16]string{
	1: "baseresp",
}

func (p *MemberListResponse) IsSetBaseresp() bool {
	return p.Baseresp != nil
}

func (p *MemberListResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MemberListResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *MemberListResponse) ReadField1(iprot thrift.TProtocol) error {
	p.Baseresp = NewBaseResp()
	if err := p.Baseresp.Read(iprot); err != nil {
		return err
	}
...
func (p *MemberListResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("MemberListResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *MemberListResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("baseresp", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Baseresp.Write(oprot); err != nil {
...
func (p *MemberListResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("MemberListResponse(%+v)", *p)
}
...
func NewAdminListResponse() *AdminListResponse {
	return &AdminListResponse{}
}

var AdminListResponse_Baseresp_DEFAULT *BaseResp

func (p *AdminListResponse) GetBaseresp() (v *BaseResp) {
	if !p.IsSetBaseresp() {
		return AdminListResponse_Baseresp_DEFAULT
	}
	return p.Baseresp
}

var fieldIDToName_AdminListResponse = map[int16]string{
	1: "baseresp",
}

func (p *AdminListResponse) IsSetBaseresp() bool {
	return p.Baseresp != nil
}

func (p *AdminListResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_AdminListResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *AdminListResponse) ReadField1(iprot thrift.TProtocol) error {
	p.Baseresp = NewBaseResp()
	if err := p.Baseresp.Read(iprot); err != nil {
		return err
	}
...
func (p *AdminListResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("AdminListResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *AdminListResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("baseresp", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Baseresp.Write(oprot); err != nil {
...
func (p *AdminListResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("AdminListResponse(%+v)", *p)
}
...
type UserService interface {
	...
	FindUser(ctx context.Context) (r *FindUserResponse, err error)

	MemberList(ctx context.Context) (r *MemberListResponse, err error)

	AdminList(ctx context.Context) (r *AdminListResponse, err error)
}
...
func (p *UserServiceClient) FindUser(ctx context.Context) (r *FindUserResponse, err error) {
...
func (p *UserServiceClient) MemberList(ctx context.Context) (r *MemberListResponse, err error) {
	var _args UserServiceMemberListArgs
	var _result UserServiceMemberListResult
	if err = p.Client_().Call(ctx, "memberList", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *UserServiceClient) AdminList(ctx context.Context) (r *AdminListResponse, err error) {
	var _args UserServiceAdminListArgs
	var _result UserServiceAdminListResult
	if err = p.Client_().Call(ctx, "adminList", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewUserServiceProcessor(handler UserService) *UserServiceProcessor {
	...
	self.AddToProcessorMap("memberList", &userServiceProcessorMemberList{handler: handler})
	self.AddToProcessorMap("adminList", &userServiceProcessorAdminList{handler: handler})
	return self
}
...
func (p *userServiceProcessorFindUser) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	if retval, err2 = p.handler.FindUser(ctx); err2 != nil {
...
type userServiceProcessorMemberList struct {
	handler UserService
}

func (p *userServiceProcessorMemberList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := UserServiceMemberListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := UserServiceMemberListResult{}
	var retval *MemberListResponse
	if retval, err2 = p.handler.MemberList(ctx); err2 != nil {
...
type userServiceProcessorAdminList struct {
	handler UserService
}

func (p *userServiceProcessorAdminList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := UserServiceAdminListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("adminList", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := UserServiceAdminListResult{}
	var retval *AdminListResponse
	if retval, err2 = p.handler.AdminList(ctx); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing adminList: "+err2.Error())
		oprot.WriteMessageBegin("adminList", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("adminList", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type UserServiceFindUserResult struct {
	Success *FindUserResponse `thrift:"success,0,optional"`
}
...
type UserServiceMemberListArgs struct {
}

func NewUserServiceMemberListArgs() *UserServiceMemberListArgs {
	return &UserServiceMemberListArgs{}
}

var fieldIDToName_UserServiceMemberListArgs = map[int16]string{}

func (p *UserServiceMemberListArgs) Read(iprot thrift.TProtocol) (err error) {
...
func (p *UserServiceMemberListArgs) Write(oprot thrift.TProtocol) (err error) {
...
func (p *UserServiceMemberListArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceMemberListArgs(%+v)", *p)
}

type UserServiceMemberListResult struct {
	Success *MemberListResponse `thrift:"success,0,optional"`
}

func NewUserServiceMemberListResult() *UserServiceMemberListResult {
	return &UserServiceMemberListResult{}
}

var UserServiceMemberListResult_Success_DEFAULT *MemberListResponse

func (p *UserServiceMemberListResult) GetSuccess() (v *MemberListResponse) {
	if !p.IsSetSuccess() {
		return UserServiceMemberListResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_UserServiceMemberListResult = map[int16]string{
	0: "success",
}

func (p *UserServiceMemberListResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *UserServiceMemberListResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceMemberListResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UserServiceMemberListResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewMemberListResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *UserServiceMemberListResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *UserServiceMemberListResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *UserServiceMemberListResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceMemberListResult(%+v)", *p)
}

type UserServiceAdminListArgs struct {
}

func NewUserServiceAdminListArgs() *UserServiceAdminListArgs {
	return &UserServiceAdminListArgs{}
}

var fieldIDToName_UserServiceAdminListArgs = map[int16]string{}

func (p *UserServiceAdminListArgs) Read(iprot thrift.TProtocol) (err error) {
...
func (p *UserServiceAdminListArgs) Write(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteStructBegin("adminList_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
...
func (p *UserServiceAdminListArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceAdminListArgs(%+v)", *p)
}

type UserServiceAdminListResult struct {
	Success *AdminListResponse `thrift:"success,0,optional"`
}

func NewUserServiceAdminListResult() *UserServiceAdminListResult {
	return &UserServiceAdminListResult{}
}

var UserServiceAdminListResult_Success_DEFAULT *AdminListResponse

func (p *UserServiceAdminListResult) GetSuccess() (v *AdminListResponse) {
	if !p.IsSetSuccess() {
		return UserServiceAdminListResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_UserServiceAdminListResult = map[int16]string{
	0: "success",
}

func (p *UserServiceAdminListResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *UserServiceAdminListResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceAdminListResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UserServiceAdminListResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewAdminListResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *UserServiceAdminListResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("adminList_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *UserServiceAdminListResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *UserServiceAdminListResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceAdminListResult(%+v)", *p)
}
