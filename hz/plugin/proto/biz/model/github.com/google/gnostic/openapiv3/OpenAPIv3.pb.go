...
type Any struct {
	...
	Value *anypb.Any `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
	Yaml  string     `protobuf:"bytes,2,opt,name=yaml,proto3" json:"yaml,omitempty" form:"yaml" query:"yaml"`
}
...
type Callback struct {
	...
	Path                   []*NamedPathItem `protobuf:"bytes,1,rep,name=path,proto3" json:"path" form:"path" query:"path"`
	SpecificationExtension []*NamedAny      `protobuf:"bytes,2,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type CallbacksOrReferences struct {
	...
	AdditionalProperties []*NamedCallbackOrReference `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type Components struct {
	...
	Schemas                *SchemasOrReferences         `protobuf:"bytes,1,opt,name=schemas,proto3" json:"schemas,omitempty" form:"schemas" query:"schemas"`
	Responses              *ResponsesOrReferences       `protobuf:"bytes,2,opt,name=responses,proto3" json:"responses,omitempty" form:"responses" query:"responses"`
	Parameters             *ParametersOrReferences      `protobuf:"bytes,3,opt,name=parameters,proto3" json:"parameters,omitempty" form:"parameters" query:"parameters"`
	Examples               *ExamplesOrReferences        `protobuf:"bytes,4,opt,name=examples,proto3" json:"examples,omitempty" form:"examples" query:"examples"`
	RequestBodies          *RequestBodiesOrReferences   `protobuf:"bytes,5,opt,name=request_bodies,json=requestBodies,proto3" json:"request_bodies,omitempty" form:"request_bodies" query:"request_bodies"`
	Headers                *HeadersOrReferences         `protobuf:"bytes,6,opt,name=headers,proto3" json:"headers,omitempty" form:"headers" query:"headers"`
	SecuritySchemes        *SecuritySchemesOrReferences `protobuf:"bytes,7,opt,name=security_schemes,json=securitySchemes,proto3" json:"security_schemes,omitempty" form:"security_schemes" query:"security_schemes"`
	Links                  *LinksOrReferences           `protobuf:"bytes,8,opt,name=links,proto3" json:"links,omitempty" form:"links" query:"links"`
	Callbacks              *CallbacksOrReferences       `protobuf:"bytes,9,opt,name=callbacks,proto3" json:"callbacks,omitempty" form:"callbacks" query:"callbacks"`
	SpecificationExtension []*NamedAny                  `protobuf:"bytes,10,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type Contact struct {
	...
	SpecificationExtension []*NamedAny `protobuf:"bytes,4,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type Discriminator struct {
	...
	PropertyName           string      `protobuf:"bytes,1,opt,name=property_name,json=propertyName,proto3" json:"property_name,omitempty" form:"property_name" query:"property_name"`
	Mapping                *Strings    `protobuf:"bytes,2,opt,name=mapping,proto3" json:"mapping,omitempty" form:"mapping" query:"mapping"`
	SpecificationExtension []*NamedAny `protobuf:"bytes,3,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type Document struct {
	...
	Openapi                string                 `protobuf:"bytes,1,opt,name=openapi,proto3" json:"openapi,omitempty" form:"openapi" query:"openapi"`
	Info                   *Info                  `protobuf:"bytes,2,opt,name=info,proto3" json:"info,omitempty" form:"info" query:"info"`
	Servers                []*Server              `protobuf:"bytes,3,rep,name=servers,proto3" json:"servers" form:"servers" query:"servers"`
	Paths                  *Paths                 `protobuf:"bytes,4,opt,name=paths,proto3" json:"paths,omitempty" form:"paths" query:"paths"`
	Components             *Components            `protobuf:"bytes,5,opt,name=components,proto3" json:"components,omitempty" form:"components" query:"components"`
	Security               []*SecurityRequirement `protobuf:"bytes,6,rep,name=security,proto3" json:"security" form:"security" query:"security"`
	Tags                   []*Tag                 `protobuf:"bytes,7,rep,name=tags,proto3" json:"tags" form:"tags" query:"tags"`
	ExternalDocs           *ExternalDocs          `protobuf:"bytes,8,opt,name=external_docs,json=externalDocs,proto3" json:"external_docs,omitempty" form:"external_docs" query:"external_docs"`
	SpecificationExtension []*NamedAny            `protobuf:"bytes,9,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type Encoding struct {
	...
	ContentType            string               `protobuf:"bytes,1,opt,name=content_type,json=contentType,proto3" json:"content_type,omitempty" form:"content_type" query:"content_type"`
	Headers                *HeadersOrReferences `protobuf:"bytes,2,opt,name=headers,proto3" json:"headers,omitempty" form:"headers" query:"headers"`
	Style                  string               `protobuf:"bytes,3,opt,name=style,proto3" json:"style,omitempty" form:"style" query:"style"`
	Explode                bool                 `protobuf:"varint,4,opt,name=explode,proto3" json:"explode,omitempty" form:"explode" query:"explode"`
	AllowReserved          bool                 `protobuf:"varint,5,opt,name=allow_reserved,json=allowReserved,proto3" json:"allow_reserved,omitempty" form:"allow_reserved" query:"allow_reserved"`
	SpecificationExtension []*NamedAny          `protobuf:"bytes,6,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type Encodings struct {
	...
	AdditionalProperties []*NamedEncoding `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type Example struct {
	...
	Summary                string      `protobuf:"bytes,1,opt,name=summary,proto3" json:"summary,omitempty" form:"summary" query:"summary"`
	...
	Value                  *Any        `protobuf:"bytes,3,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
	ExternalValue          string      `protobuf:"bytes,4,opt,name=external_value,json=externalValue,proto3" json:"external_value,omitempty" form:"external_value" query:"external_value"`
	SpecificationExtension []*NamedAny `protobuf:"bytes,5,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type ExamplesOrReferences struct {
	...
	AdditionalProperties []*NamedExampleOrReference `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type Expression struct {
	...
	AdditionalProperties []*NamedAny `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type ExternalDocs struct {
	...
	Description            string      `protobuf:"bytes,1,opt,name=description,proto3" json:"description,omitempty" form:"description" query:"description"`
	Url                    string      `protobuf:"bytes,2,opt,name=url,proto3" json:"url,omitempty" form:"url" query:"url"`
	SpecificationExtension []*NamedAny `protobuf:"bytes,3,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type Header struct {
	...
	Description            string                `protobuf:"bytes,1,opt,name=description,proto3" json:"description,omitempty" form:"description" query:"description"`
	Required               bool                  `protobuf:"varint,2,opt,name=required,proto3" json:"required,omitempty" form:"required" query:"required"`
	Deprecated             bool                  `protobuf:"varint,3,opt,name=deprecated,proto3" json:"deprecated,omitempty" form:"deprecated" query:"deprecated"`
	AllowEmptyValue        bool                  `protobuf:"varint,4,opt,name=allow_empty_value,json=allowEmptyValue,proto3" json:"allow_empty_value,omitempty" form:"allow_empty_value" query:"allow_empty_value"`
	Style                  string                `protobuf:"bytes,5,opt,name=style,proto3" json:"style,omitempty" form:"style" query:"style"`
	Explode                bool                  `protobuf:"varint,6,opt,name=explode,proto3" json:"explode,omitempty" form:"explode" query:"explode"`
	AllowReserved          bool                  `protobuf:"varint,7,opt,name=allow_reserved,json=allowReserved,proto3" json:"allow_reserved,omitempty" form:"allow_reserved" query:"allow_reserved"`
	Schema                 *SchemaOrReference    `protobuf:"bytes,8,opt,name=schema,proto3" json:"schema,omitempty" form:"schema" query:"schema"`
	Example                *Any                  `protobuf:"bytes,9,opt,name=example,proto3" json:"example,omitempty" form:"example" query:"example"`
	Examples               *ExamplesOrReferences `protobuf:"bytes,10,opt,name=examples,proto3" json:"examples,omitempty" form:"examples" query:"examples"`
	Content                *MediaTypes           `protobuf:"bytes,11,opt,name=content,proto3" json:"content,omitempty" form:"content" query:"content"`
	SpecificationExtension []*NamedAny           `protobuf:"bytes,12,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type HeadersOrReferences struct {
	...
	AdditionalProperties []*NamedHeaderOrReference `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type Info struct {
	...
	Description            string      `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty" form:"description" query:"description"`
	TermsOfService         string      `protobuf:"bytes,3,opt,name=terms_of_service,json=termsOfService,proto3" json:"terms_of_service,omitempty" form:"terms_of_service" query:"terms_of_service"`
	Contact                *Contact    `protobuf:"bytes,4,opt,name=contact,proto3" json:"contact,omitempty" form:"contact" query:"contact"`
	License                *License    `protobuf:"bytes,5,opt,name=license,proto3" json:"license,omitempty" form:"license" query:"license"`
	Version                string      `protobuf:"bytes,6,opt,name=version,proto3" json:"version,omitempty" form:"version" query:"version"`
	SpecificationExtension []*NamedAny `protobuf:"bytes,7,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
	Summary                string      `protobuf:"bytes,8,opt,name=summary,proto3" json:"summary,omitempty" form:"summary" query:"summary"`
}
...
type ItemsItem struct {
	...
	SchemaOrReference []*SchemaOrReference `protobuf:"bytes,1,rep,name=schema_or_reference,json=schemaOrReference,proto3" json:"schema_or_reference" form:"schema_or_reference" query:"schema_or_reference"`
}
...
type Link struct {
	...
	OperationRef           string           `protobuf:"bytes,1,opt,name=operation_ref,json=operationRef,proto3" json:"operation_ref,omitempty" form:"operation_ref" query:"operation_ref"`
	OperationId            string           `protobuf:"bytes,2,opt,name=operation_id,json=operationId,proto3" json:"operation_id,omitempty" form:"operation_id" query:"operation_id"`
	Parameters             *AnyOrExpression `protobuf:"bytes,3,opt,name=parameters,proto3" json:"parameters,omitempty" form:"parameters" query:"parameters"`
	RequestBody            *AnyOrExpression `protobuf:"bytes,4,opt,name=request_body,json=requestBody,proto3" json:"request_body,omitempty" form:"request_body" query:"request_body"`
	...
	Server                 *Server          `protobuf:"bytes,6,opt,name=server,proto3" json:"server,omitempty" form:"server" query:"server"`
	SpecificationExtension []*NamedAny      `protobuf:"bytes,7,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type LinksOrReferences struct {
	...
	AdditionalProperties []*NamedLinkOrReference `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type MediaType struct {
	...
	Schema                 *SchemaOrReference    `protobuf:"bytes,1,opt,name=schema,proto3" json:"schema,omitempty" form:"schema" query:"schema"`
	Example                *Any                  `protobuf:"bytes,2,opt,name=example,proto3" json:"example,omitempty" form:"example" query:"example"`
	Examples               *ExamplesOrReferences `protobuf:"bytes,3,opt,name=examples,proto3" json:"examples,omitempty" form:"examples" query:"examples"`
	Encoding               *Encodings            `protobuf:"bytes,4,opt,name=encoding,proto3" json:"encoding,omitempty" form:"encoding" query:"encoding"`
	SpecificationExtension []*NamedAny           `protobuf:"bytes,5,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type MediaTypes struct {
	...
	AdditionalProperties []*NamedMediaType `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type NamedAny struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *Any `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedCallbackOrReference struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *CallbackOrReference `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedEncoding struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *Encoding `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedExampleOrReference struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *ExampleOrReference `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedHeaderOrReference struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *HeaderOrReference `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedLinkOrReference struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *LinkOrReference `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedMediaType struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *MediaType `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedParameterOrReference struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *ParameterOrReference `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedPathItem struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *PathItem `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedRequestBodyOrReference struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *RequestBodyOrReference `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedResponseOrReference struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *ResponseOrReference `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedSchemaOrReference struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *SchemaOrReference `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedSecuritySchemeOrReference struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *SecuritySchemeOrReference `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedServerVariable struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *ServerVariable `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type NamedStringArray struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	// Mapped value
	Value *StringArray `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" form:"value" query:"value"`
}
...
type OauthFlow struct {
	...
	AuthorizationUrl       string      `protobuf:"bytes,1,opt,name=authorization_url,json=authorizationUrl,proto3" json:"authorization_url,omitempty" form:"authorization_url" query:"authorization_url"`
	TokenUrl               string      `protobuf:"bytes,2,opt,name=token_url,json=tokenUrl,proto3" json:"token_url,omitempty" form:"token_url" query:"token_url"`
	RefreshUrl             string      `protobuf:"bytes,3,opt,name=refresh_url,json=refreshUrl,proto3" json:"refresh_url,omitempty" form:"refresh_url" query:"refresh_url"`
	Scopes                 *Strings    `protobuf:"bytes,4,opt,name=scopes,proto3" json:"scopes,omitempty" form:"scopes" query:"scopes"`
	SpecificationExtension []*NamedAny `protobuf:"bytes,5,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type OauthFlows struct {
	...
	Implicit               *OauthFlow  `protobuf:"bytes,1,opt,name=implicit,proto3" json:"implicit,omitempty" form:"implicit" query:"implicit"`
	Password               *OauthFlow  `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty" form:"password" query:"password"`
	ClientCredentials      *OauthFlow  `protobuf:"bytes,3,opt,name=client_credentials,json=clientCredentials,proto3" json:"client_credentials,omitempty" form:"client_credentials" query:"client_credentials"`
	AuthorizationCode      *OauthFlow  `protobuf:"bytes,4,opt,name=authorization_code,json=authorizationCode,proto3" json:"authorization_code,omitempty" form:"authorization_code" query:"authorization_code"`
	SpecificationExtension []*NamedAny `protobuf:"bytes,5,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type Operation struct {
	...
	Tags                   []string                `protobuf:"bytes,1,rep,name=tags,proto3" json:"tags" form:"tags" query:"tags"`
	Summary                string                  `protobuf:"bytes,2,opt,name=summary,proto3" json:"summary,omitempty" form:"summary" query:"summary"`
	...
	ExternalDocs           *ExternalDocs           `protobuf:"bytes,4,opt,name=external_docs,json=externalDocs,proto3" json:"external_docs,omitempty" form:"external_docs" query:"external_docs"`
	OperationId            string                  `protobuf:"bytes,5,opt,name=operation_id,json=operationId,proto3" json:"operation_id,omitempty" form:"operation_id" query:"operation_id"`
	Parameters             []*ParameterOrReference `protobuf:"bytes,6,rep,name=parameters,proto3" json:"parameters" form:"parameters" query:"parameters"`
	RequestBody            *RequestBodyOrReference `protobuf:"bytes,7,opt,name=request_body,json=requestBody,proto3" json:"request_body,omitempty" form:"request_body" query:"request_body"`
	Responses              *Responses              `protobuf:"bytes,8,opt,name=responses,proto3" json:"responses,omitempty" form:"responses" query:"responses"`
	Callbacks              *CallbacksOrReferences  `protobuf:"bytes,9,opt,name=callbacks,proto3" json:"callbacks,omitempty" form:"callbacks" query:"callbacks"`
	Deprecated             bool                    `protobuf:"varint,10,opt,name=deprecated,proto3" json:"deprecated,omitempty" form:"deprecated" query:"deprecated"`
	Security               []*SecurityRequirement  `protobuf:"bytes,11,rep,name=security,proto3" json:"security" form:"security" query:"security"`
	Servers                []*Server               `protobuf:"bytes,12,rep,name=servers,proto3" json:"servers" form:"servers" query:"servers"`
	SpecificationExtension []*NamedAny             `protobuf:"bytes,13,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type Parameter struct {
	...
	Name                   string                `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	In                     string                `protobuf:"bytes,2,opt,name=in,proto3" json:"in,omitempty" form:"in" query:"in"`
	Description            string                `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty" form:"description" query:"description"`
	Required               bool                  `protobuf:"varint,4,opt,name=required,proto3" json:"required,omitempty" form:"required" query:"required"`
	Deprecated             bool                  `protobuf:"varint,5,opt,name=deprecated,proto3" json:"deprecated,omitempty" form:"deprecated" query:"deprecated"`
	AllowEmptyValue        bool                  `protobuf:"varint,6,opt,name=allow_empty_value,json=allowEmptyValue,proto3" json:"allow_empty_value,omitempty" form:"allow_empty_value" query:"allow_empty_value"`
	Style                  string                `protobuf:"bytes,7,opt,name=style,proto3" json:"style,omitempty" form:"style" query:"style"`
	Explode                bool                  `protobuf:"varint,8,opt,name=explode,proto3" json:"explode,omitempty" form:"explode" query:"explode"`
	AllowReserved          bool                  `protobuf:"varint,9,opt,name=allow_reserved,json=allowReserved,proto3" json:"allow_reserved,omitempty" form:"allow_reserved" query:"allow_reserved"`
	Schema                 *SchemaOrReference    `protobuf:"bytes,10,opt,name=schema,proto3" json:"schema,omitempty" form:"schema" query:"schema"`
	Example                *Any                  `protobuf:"bytes,11,opt,name=example,proto3" json:"example,omitempty" form:"example" query:"example"`
	Examples               *ExamplesOrReferences `protobuf:"bytes,12,opt,name=examples,proto3" json:"examples,omitempty" form:"examples" query:"examples"`
	Content                *MediaTypes           `protobuf:"bytes,13,opt,name=content,proto3" json:"content,omitempty" form:"content" query:"content"`
	SpecificationExtension []*NamedAny           `protobuf:"bytes,14,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type ParametersOrReferences struct {
	...
	AdditionalProperties []*NamedParameterOrReference `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type PathItem struct {
	...
	XRef                   string                  `protobuf:"bytes,1,opt,name=_ref,json=Ref,proto3" json:"_ref,omitempty" form:"_ref" query:"_ref"`
	Summary                string                  `protobuf:"bytes,2,opt,name=summary,proto3" json:"summary,omitempty" form:"summary" query:"summary"`
	Description            string                  `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty" form:"description" query:"description"`
	Get                    *Operation              `protobuf:"bytes,4,opt,name=get,proto3" json:"get,omitempty" form:"get" query:"get"`
	Put                    *Operation              `protobuf:"bytes,5,opt,name=put,proto3" json:"put,omitempty" form:"put" query:"put"`
	Post                   *Operation              `protobuf:"bytes,6,opt,name=post,proto3" json:"post,omitempty" form:"post" query:"post"`
	Delete                 *Operation              `protobuf:"bytes,7,opt,name=delete,proto3" json:"delete,omitempty" form:"delete" query:"delete"`
	Options                *Operation              `protobuf:"bytes,8,opt,name=options,proto3" json:"options,omitempty" form:"options" query:"options"`
	Head                   *Operation              `protobuf:"bytes,9,opt,name=head,proto3" json:"head,omitempty" form:"head" query:"head"`
	Patch                  *Operation              `protobuf:"bytes,10,opt,name=patch,proto3" json:"patch,omitempty" form:"patch" query:"patch"`
	Trace                  *Operation              `protobuf:"bytes,11,opt,name=trace,proto3" json:"trace,omitempty" form:"trace" query:"trace"`
	Servers                []*Server               `protobuf:"bytes,12,rep,name=servers,proto3" json:"servers" form:"servers" query:"servers"`
	Parameters             []*ParameterOrReference `protobuf:"bytes,13,rep,name=parameters,proto3" json:"parameters" form:"parameters" query:"parameters"`
	SpecificationExtension []*NamedAny             `protobuf:"bytes,14,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type Properties struct {
	...
	AdditionalProperties []*NamedSchemaOrReference `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type RequestBodiesOrReferences struct {
	...
	AdditionalProperties []*NamedRequestBodyOrReference `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type RequestBody struct {
	...
	Description            string      `protobuf:"bytes,1,opt,name=description,proto3" json:"description,omitempty" form:"description" query:"description"`
	Content                *MediaTypes `protobuf:"bytes,2,opt,name=content,proto3" json:"content,omitempty" form:"content" query:"content"`
	Required               bool        `protobuf:"varint,3,opt,name=required,proto3" json:"required,omitempty" form:"required" query:"required"`
	SpecificationExtension []*NamedAny `protobuf:"bytes,4,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type Response struct {
	...
	Description            string               `protobuf:"bytes,1,opt,name=description,proto3" json:"description,omitempty" form:"description" query:"description"`
	Headers                *HeadersOrReferences `protobuf:"bytes,2,opt,name=headers,proto3" json:"headers,omitempty" form:"headers" query:"headers"`
	Content                *MediaTypes          `protobuf:"bytes,3,opt,name=content,proto3" json:"content,omitempty" form:"content" query:"content"`
	Links                  *LinksOrReferences   `protobuf:"bytes,4,opt,name=links,proto3" json:"links,omitempty" form:"links" query:"links"`
	SpecificationExtension []*NamedAny          `protobuf:"bytes,5,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type Responses struct {
	...
	Default                *ResponseOrReference        `protobuf:"bytes,1,opt,name=default,proto3" json:"default,omitempty" form:"default" query:"default"`
	ResponseOrReference    []*NamedResponseOrReference `protobuf:"bytes,2,rep,name=response_or_reference,json=responseOrReference,proto3" json:"response_or_reference" form:"response_or_reference" query:"response_or_reference"`
	SpecificationExtension []*NamedAny                 `protobuf:"bytes,3,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type ResponsesOrReferences struct {
	...
	AdditionalProperties []*NamedResponseOrReference `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type Schema struct {
	...
	Nullable               bool                      `protobuf:"varint,1,opt,name=nullable,proto3" json:"nullable,omitempty" form:"nullable" query:"nullable"`
	Discriminator          *Discriminator            `protobuf:"bytes,2,opt,name=discriminator,proto3" json:"discriminator,omitempty" form:"discriminator" query:"discriminator"`
	ReadOnly               bool                      `protobuf:"varint,3,opt,name=read_only,json=readOnly,proto3" json:"read_only,omitempty" form:"read_only" query:"read_only"`
	WriteOnly              bool                      `protobuf:"varint,4,opt,name=write_only,json=writeOnly,proto3" json:"write_only,omitempty" form:"write_only" query:"write_only"`
	Xml                    *Xml                      `protobuf:"bytes,5,opt,name=xml,proto3" json:"xml,omitempty" form:"xml" query:"xml"`
	ExternalDocs           *ExternalDocs             `protobuf:"bytes,6,opt,name=external_docs,json=externalDocs,proto3" json:"external_docs,omitempty" form:"external_docs" query:"external_docs"`
	Example                *Any                      `protobuf:"bytes,7,opt,name=example,proto3" json:"example,omitempty" form:"example" query:"example"`
	Deprecated             bool                      `protobuf:"varint,8,opt,name=deprecated,proto3" json:"deprecated,omitempty" form:"deprecated" query:"deprecated"`
	Title                  string                    `protobuf:"bytes,9,opt,name=title,proto3" json:"title,omitempty" form:"title" query:"title"`
	MultipleOf             float64                   `protobuf:"fixed64,10,opt,name=multiple_of,json=multipleOf,proto3" json:"multiple_of,omitempty" form:"multiple_of" query:"multiple_of"`
	Maximum                float64                   `protobuf:"fixed64,11,opt,name=maximum,proto3" json:"maximum,omitempty" form:"maximum" query:"maximum"`
	ExclusiveMaximum       bool                      `protobuf:"varint,12,opt,name=exclusive_maximum,json=exclusiveMaximum,proto3" json:"exclusive_maximum,omitempty" form:"exclusive_maximum" query:"exclusive_maximum"`
	Minimum                float64                   `protobuf:"fixed64,13,opt,name=minimum,proto3" json:"minimum,omitempty" form:"minimum" query:"minimum"`
	ExclusiveMinimum       bool                      `protobuf:"varint,14,opt,name=exclusive_minimum,json=exclusiveMinimum,proto3" json:"exclusive_minimum,omitempty" form:"exclusive_minimum" query:"exclusive_minimum"`
	MaxLength              int64                     `protobuf:"varint,15,opt,name=max_length,json=maxLength,proto3" json:"max_length,omitempty" form:"max_length" query:"max_length"`
	MinLength              int64                     `protobuf:"varint,16,opt,name=min_length,json=minLength,proto3" json:"min_length,omitempty" form:"min_length" query:"min_length"`
	Pattern                string                    `protobuf:"bytes,17,opt,name=pattern,proto3" json:"pattern,omitempty" form:"pattern" query:"pattern"`
	MaxItems               int64                     `protobuf:"varint,18,opt,name=max_items,json=maxItems,proto3" json:"max_items,omitempty" form:"max_items" query:"max_items"`
	MinItems               int64                     `protobuf:"varint,19,opt,name=min_items,json=minItems,proto3" json:"min_items,omitempty" form:"min_items" query:"min_items"`
	UniqueItems            bool                      `protobuf:"varint,20,opt,name=unique_items,json=uniqueItems,proto3" json:"unique_items,omitempty" form:"unique_items" query:"unique_items"`
	MaxProperties          int64                     `protobuf:"varint,21,opt,name=max_properties,json=maxProperties,proto3" json:"max_properties,omitempty" form:"max_properties" query:"max_properties"`
	MinProperties          int64                     `protobuf:"varint,22,opt,name=min_properties,json=minProperties,proto3" json:"min_properties,omitempty" form:"min_properties" query:"min_properties"`
	Required               []string                  `protobuf:"bytes,23,rep,name=required,proto3" json:"required" form:"required" query:"required"`
	Enum                   []*Any                    `protobuf:"bytes,24,rep,name=enum,proto3" json:"enum" form:"enum" query:"enum"`
	Type                   string                    `protobuf:"bytes,25,opt,name=type,proto3" json:"type,omitempty" form:"type" query:"type"`
	AllOf                  []*SchemaOrReference      `protobuf:"bytes,26,rep,name=all_of,json=allOf,proto3" json:"all_of" form:"all_of" query:"all_of"`
	OneOf                  []*SchemaOrReference      `protobuf:"bytes,27,rep,name=one_of,json=oneOf,proto3" json:"one_of" form:"one_of" query:"one_of"`
	AnyOf                  []*SchemaOrReference      `protobuf:"bytes,28,rep,name=any_of,json=anyOf,proto3" json:"any_of" form:"any_of" query:"any_of"`
	Not                    *Schema                   `protobuf:"bytes,29,opt,name=not,proto3" json:"not,omitempty" form:"not" query:"not"`
	Items                  *ItemsItem                `protobuf:"bytes,30,opt,name=items,proto3" json:"items,omitempty" form:"items" query:"items"`
	Properties             *Properties               `protobuf:"bytes,31,opt,name=properties,proto3" json:"properties,omitempty" form:"properties" query:"properties"`
	AdditionalProperties   *AdditionalPropertiesItem `protobuf:"bytes,32,opt,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties,omitempty" form:"additional_properties" query:"additional_properties"`
	Default                *DefaultType              `protobuf:"bytes,33,opt,name=default,proto3" json:"default,omitempty" form:"default" query:"default"`
	Description            string                    `protobuf:"bytes,34,opt,name=description,proto3" json:"description,omitempty" form:"description" query:"description"`
	Format                 string                    `protobuf:"bytes,35,opt,name=format,proto3" json:"format,omitempty" form:"format" query:"format"`
	SpecificationExtension []*NamedAny               `protobuf:"bytes,36,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type SecurityRequirement struct {
	...
	AdditionalProperties []*NamedStringArray `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type SecurityScheme struct {
	...
	In                     string      `protobuf:"bytes,4,opt,name=in,proto3" json:"in,omitempty" form:"in" query:"in"`
	Scheme                 string      `protobuf:"bytes,5,opt,name=scheme,proto3" json:"scheme,omitempty" form:"scheme" query:"scheme"`
	BearerFormat           string      `protobuf:"bytes,6,opt,name=bearer_format,json=bearerFormat,proto3" json:"bearer_format,omitempty" form:"bearer_format" query:"bearer_format"`
	Flows                  *OauthFlows `protobuf:"bytes,7,opt,name=flows,proto3" json:"flows,omitempty" form:"flows" query:"flows"`
	OpenIdConnectUrl       string      `protobuf:"bytes,8,opt,name=open_id_connect_url,json=openIdConnectUrl,proto3" json:"open_id_connect_url,omitempty" form:"open_id_connect_url" query:"open_id_connect_url"`
	SpecificationExtension []*NamedAny `protobuf:"bytes,9,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type SecuritySchemesOrReferences struct {
	...
	AdditionalProperties []*NamedSecuritySchemeOrReference `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type Server struct {
	...
	Description            string           `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty" form:"description" query:"description"`
	Variables              *ServerVariables `protobuf:"bytes,3,opt,name=variables,proto3" json:"variables,omitempty" form:"variables" query:"variables"`
	SpecificationExtension []*NamedAny      `protobuf:"bytes,4,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type ServerVariable struct {
	...
	Enum                   []string    `protobuf:"bytes,1,rep,name=enum,proto3" json:"enum" form:"enum" query:"enum"`
	Default                string      `protobuf:"bytes,2,opt,name=default,proto3" json:"default,omitempty" form:"default" query:"default"`
	Description            string      `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty" form:"description" query:"description"`
	SpecificationExtension []*NamedAny `protobuf:"bytes,4,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type ServerVariables struct {
	...
	AdditionalProperties []*NamedServerVariable `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type StringArray struct {
	...
	Value []string `protobuf:"bytes,1,rep,name=value,proto3" json:"value" form:"value" query:"value"`
}
...
type Strings struct {
	...
	AdditionalProperties []*NamedString `protobuf:"bytes,1,rep,name=additional_properties,json=additionalProperties,proto3" json:"additional_properties" form:"additional_properties" query:"additional_properties"`
}
...
type Tag struct {
	...
	Name                   string        `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	Description            string        `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty" form:"description" query:"description"`
	ExternalDocs           *ExternalDocs `protobuf:"bytes,3,opt,name=external_docs,json=externalDocs,proto3" json:"external_docs,omitempty" form:"external_docs" query:"external_docs"`
	SpecificationExtension []*NamedAny   `protobuf:"bytes,4,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
type Xml struct {
	...
	Name                   string      `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	Namespace              string      `protobuf:"bytes,2,opt,name=namespace,proto3" json:"namespace,omitempty" form:"namespace" query:"namespace"`
	Prefix                 string      `protobuf:"bytes,3,opt,name=prefix,proto3" json:"prefix,omitempty" form:"prefix" query:"prefix"`
	Attribute              bool        `protobuf:"varint,4,opt,name=attribute,proto3" json:"attribute,omitempty" form:"attribute" query:"attribute"`
	Wrapped                bool        `protobuf:"varint,5,opt,name=wrapped,proto3" json:"wrapped,omitempty" form:"wrapped" query:"wrapped"`
	SpecificationExtension []*NamedAny `protobuf:"bytes,6,rep,name=specification_extension,json=specificationExtension,proto3" json:"specification_extension" form:"specification_extension" query:"specification_extension"`
}
...
var file_openapiv3_OpenAPIv3_proto_rawDesc = []byte{
	...
	0x32, 0x14, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x33, 0x2e, 0x4e, 0x61,
	0x6d, 0x65, 0x64, 0x41, 0x6e, 0x79, 0x52, 0x16, 0x73, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x63,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x66,
	...
	0x5a, 0x3e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2f, 0x68, 0x65, 0x72,
	0x74, 0x7a, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x67, 0x69, 0x74,
