...
type Http struct {
	...
	Rules []*HttpRule `protobuf:"bytes,1,rep,name=rules,proto3" json:"rules" form:"rules" query:"rules"`
...
type HttpRule struct {
	...
	AdditionalBindings []*HttpRule `protobuf:"bytes,11,rep,name=additional_bindings,json=additionalBindings,proto3" json:"additional_bindings" form:"additional_bindings" query:"additional_bindings"`
}
...
var file_google_api_http_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x50, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77,
	0x61, 0x72, 0x65, 0x2f, 0x68, 0x65, 0x72, 0x74, 0x7a, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f,
